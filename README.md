...
MVP of a deterministic network configuration compiler. The first CLI is `netc`.

The first version parses Cisco IOS-like configuration files into a small canonical IR and runs deterministic queries with file/line/block evidence.
